CLASS z2ui5_cl_popup_show_tr DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA mt_data TYPE STANDARD TABLE OF ty_s_data WITH DEFAULT KEY.
...
CLASS z2ui5_cl_popup_show_tr IMPLEMENTATION.
  ...
  METHOD on_event.
        DATA line TYPE z2ui5_cl_popup_show_tr=>ty_s_data.
...
*    ELSE.
  ...
  METHOD add_to_transport_onprem.
    ...
    r_e071k = set_e071k( ir_data      = ir_data
                               iv_tabname   = iv_tabname
                               is_transport = is_transport ).
    ...
    r_e071 = set_e071( iv_tabname   = iv_tabname
                             is_transport = is_transport ).
...
*    ENDLOOP.
  ...
  METHOD get_tr_onprem.
    ...
    DATA table_name TYPE c LENGTH 4.
        ...
        DATA data TYPE REF TO z2ui5_cl_popup_show_tr=>ty_s_data.
